...
async def btn(update: Update, ctx: ContextTypes.DEFAULT_TYPE):
    ...
    # ── SNIPER MODE v2 ─────────────────────────────────────────────────────────
        ...
        await q.edit_message_text(
            ...
            "MC *" + mc_str(sf.get("min_mc", 10_000)) + "–" + mc_str(sf.get("max_mc", 200_000)) + "*\n"
            "  Buy amt: *" + money(sf.get("buy_amount", 100)) + "*  ·  "
            "Age ≤ *" + str(sf.get("max_age_h", 72)) + "h*",
            parse_mode="Markdown",
            reply_markup=InlineKeyboardMarkup([
        ...
        await q.edit_message_text(
            ...
            "MC Range: *"     + mc_str(sf.get("min_mc",        10_000)) + "* → *" + mc_str(sf.get("max_mc", 200_000)) + "*\n"
            "Max Age: *"      + str(sf.get("max_age_h",  72))           + "h*\n"
            "Min Buys/1h: *"  + str(sf.get("min_buys_h1", 10))         + "*\n"
            "Min Buy%: *"     + str(sf.get("min_buy_pct",   50))        + "%*\n"

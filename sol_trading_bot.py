        ...
        for item in unique_items:
            ...
            for uid, ud in active_users:
                try:
                    ...
                    eff_min_score   = int(sf.get("min_score",   45))
                    eff_min_liq     = float(sf.get("min_liq",   15_000))
                    eff_min_mc      = float(sf.get("min_mc",    20_000))
                    eff_max_mc      = float(sf.get("max_mc", 3_000_000))
                    eff_max_age     = float(sf.get("max_age_h",    5.0))
                    eff_min_buys    = int(sf.get("min_buys_h1",    30))
                    eff_min_buy_pct = int(sf.get("min_buy_pct",    55))
                    eff_max_vol_mc  = float(sf.get("max_vol_mc_ratio", 5.0))

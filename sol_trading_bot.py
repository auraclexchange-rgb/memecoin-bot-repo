    ...
    try:
        ...
        for item in unique_items:
            ...
            try:
                ...
                import time as _sj_t
                _kol_hits = [
                    e for e in _kol_hot_contracts.get(contract, [])
                    if _sj_t.time() - e["ts"] < 3600  # only last 1h
                ]
                ...
                if cx < 1.2:
                    ...
                    if bpm5 < 45:
                        ...
                        if _partial_ts == 0:
                            ...
                            continue
                        elif _now_ts - _partial_ts < 60:
                            continue  # within grace window
                        # 60s passed and still decaying — exit remainder

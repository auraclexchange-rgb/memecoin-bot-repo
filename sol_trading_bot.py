        ...
        if action == "set_balance":
            ...
            try:
                ...
                if bet > 0 and bet > ud["balance"]:
                    ...
                    return
                # Move to step 2: ask days
                pending[u.id] = {"action": "comp_days", "bet": bet}
                await message.reply_text(
                    f"✅ Bet: {'Free' if bet == 0 else money(bet) + ' per player'}\n\n"
                    f"⏳ How many days should the competition run?\n\n"
                    f"Example: 7",
                    reply_markup=cancel_kb()
                )
            except ValueError:
            ...
            try:
                ...
                await message.reply_text("❌ Enter a whole number. Example: 7", reply_markup=cancel_kb())

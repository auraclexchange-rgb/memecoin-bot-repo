                            ...
                            if _ud3.get("apex_mode") or _ud3.get("sniper_advisory"):
                                try:
                                    await ctx.bot.send_message(
                                        chat_id=_uid3, parse_mode="Markdown",
                                        text=(
                                            "\U0001f4a1 *NARRATIVE FORMING*\n\n"
                                            "*" + _nkw.upper() + "* tokens trending \u2014 "
                                            + str(_kw_counts[_nkw]) + " launches in this scan cycle.\n"
                                            "_Score threshold lowered 5pts for this cluster._"
                                        )
                                    )
                                except Exception:
                                    pass
...
async def btn(update: Update, ctx: ContextTypes.DEFAULT_TYPE):
    ...
    # ── APEX VAULT MENU ───────────────────────────────────────────────────────
        ...
        _trail_str = "2.5x (ratchet)" if profile == "hunter" else "1.5x"
        ...
        await q.edit_message_text(
            ...
            "🎯 *Hunter  (Sajad Strategy — Season 1)*\n"
            ...
            reply_markup=InlineKeyboardMarkup([
                ...
                [InlineKeyboardButton(_tick("hunter")  + "🎯 Hunter  (Sajad S1)",  callback_data="apex_profile_set_hunter")],

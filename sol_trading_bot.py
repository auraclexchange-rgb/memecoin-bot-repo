...
APEX_MIN_CONFIDENCE     = 7    # raised from 6 — only high-conviction signals
...
def main():
    ...
    for _uid, _ud in users.items():
        ...
        _changed = False
        if _ud.get("apex_learn_threshold", 7) < 7:
            _ud["apex_learn_threshold"] = 7
            _changed = True

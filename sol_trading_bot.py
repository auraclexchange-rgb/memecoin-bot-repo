...
def sniper_score(info: dict) -> dict:
    ...
    # (bonding curve controls supply). Only flag non-pump.fun tokens.
    if no_mint is False and not pf_curve:
            ...
            for uid, ud in active_users:
                try:
                    ...
                    if skip_reason:
                        ...
                        # ── Dump log channel: send compact line for every skip ────
                        ...
                        if _dl_ch and ud.get("sniper_log_channel_on", True):
                            try:
                                ...
                                _dl_reason = skip_reason[:80] if skip_reason else "?"
                                _dl_text   = (
                                ...
                                await ctx.bot.send_message(
                                    chat_id=int(_dl_ch), text=_dl_text,

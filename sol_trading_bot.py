...
def buy_kb(contract: str, ud: dict) -> InlineKeyboardMarkup:
    ...
    as_lbl    = "🎯 Auto Sell ✅" if h.get("auto_sells")    else "🎯 Auto Sell"
    sl_lbl    = "🛑 Stop Loss ✅" if h.get("stop_loss_pct") else "🛑 Stop Loss"
    ...
    rows = [
        ...
        # Row 5 — Set Alert | Track
        [InlineKeyboardButton("🔔 Set Alert",   callback_data="pal_" + contract),
    ...
    for item in raw_tokens:
        ...
        for uid, ud in active_users:
            try:
                ...
                # Log every decision with full AI details
...
async def btn(update: Update, ctx: ContextTypes.DEFAULT_TYPE):
    ...
    # ── SNIPER MODE v2 ─────────────────────────────────────────────────────────
        ...
        txt = (
            ...
            "AURACLE Score: *" + str(e.get("score",0)) + "/100*\n\n"
            + verdict_emoji + " *Verdict: " + e.get("verdict","?") + "*" + bought_line + "\n"
            "Confidence: *" + str(conf) + "/10*  `" + conf_bar + "`\n\n"
            "📝 *Why:*\n" + (e.get("thesis","No thesis available.") or "No thesis available.") + "\n\n"
            "━━━━━━━━━━━━━━━━\n"
